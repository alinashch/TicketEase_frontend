...
@Composable
fun UncorrectTextBuyer(navController: NavHostController) {
    Box(
        ...
        Column(modifier= Modifier.height(600.dp).width(300.dp))
        {
            Box(contentAlignment = Alignment.Center) {
                Text(
                    text = "Ой, ошибочка вышла! Некорректно введены данные",
                    fontSize = 32.sp,
                    lineHeight = 50.sp,
                    color = Color.White
                )
            ...
            Box(contentAlignment = Alignment.Center) {
                    ...
                    )
                {
                    ...
                    Column {
                        Text("Попробовать еще раз", fontSize = 25.sp, color = Color.White)
