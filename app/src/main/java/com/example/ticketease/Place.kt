...
fun getPlace(city:String) :List<PlaceDTO>{
    ...
    if (city == "Moscow") {
        ...
        var p=PlaceDTO(20, "Концертный зал в здании Екатерининского собрания" , 3000, 60, 60, "Санкт-Петербург, наб. канала Грибоедова, 88–90", "Voronezh")
        var p2=PlaceDTO(21, "Малый зал Петербургской филармонии" , 1000, 40, 80, "Санкт-Петербург, Невский просп., 30", "Voronezh")
        var p3=PlaceDTO(22, "Концертный зал Мариинского театра" , 1000, 60, 80, "Санкт-Петербург, Писарева, 20", "Voronezh")
        var p4=PlaceDTO(23, "Космонавт" , 8000, 20, 180, "Санкт-Петербург, Бронницкая, 24", "Voronezh")
        var p5=PlaceDTO(24, "Центр современного искусства им. Сергея Курехина" , 500, 20, 80, "Санкт-Петербург, Лиговский просп., 73", "Voronezh")
        var l:List<PlaceDTO> =listOf(p,p2, p2, p3, p4, p5)
    }
    return listOf()
}